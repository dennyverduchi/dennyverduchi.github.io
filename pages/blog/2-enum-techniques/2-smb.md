...
<div class="row">
  <div class="column3"><a href="/pages/blog/2-enum-techniques/1-web-app" style="font-size: 18px">Back<< Web applications</a></div>
  <div class="column1"></div>
  <div class="column3"><a href="/pages/blog/2-enum-techniques/3-ldap" style="font-size: 18px" >Next>> LDAP (Lightweight Directory Access Protocol)</a><div>
</div>